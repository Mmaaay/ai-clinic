...
export function PatientListTable({
  ...
  return (
    <div className="overflow-hidden rounded-xl border border-border/70 bg-card">
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-2 sm:gap-3 border-b border-border/70 px-3 sm:px-4 py-2.5 sm:py-3">
        <input
        ...
        />
        <div className="text-xs text-muted-foreground text-right sm:text-left whitespace-nowrap">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-2 border-t border-border/70 px-3 sm:px-4 py-2.5 sm:py-3 text-sm text-muted-foreground">
